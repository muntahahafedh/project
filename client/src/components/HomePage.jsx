...
import BottomNav from "./BottomNav.jsx"; // <- عدلت لاستيراد default
...
const HomePage = ({ user }) => {
  ...
  const recommendations = [
    { id: 1, type: "event", title: "Job Fair - Salalah", date: "Nov 15, 2025", icon: Calendar },
    { id: 2, type: "place", title: "Accessible Café Downtown", rating: "4.8 ⭐", icon: MapPin },
    { id: 3, type: "job", title: "UI Designer at TechCorp", location: "Remote", icon: Briefcase },
  ];
...
export default HomePage; // <- تصدير default
